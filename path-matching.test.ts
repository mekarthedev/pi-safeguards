...
import { makePathMatcher, normalize } from "./path-matching"
...
describe("path segments", () => {
    test("simplest match", () => {
        const matcher = makePathMatcher("test")("/home")("/proj")
    ...
    test("only full segments", () => {
        const matcher = makePathMatcher("src/config")("/home")("/proj")
    ...
    test("absolute pattern matches only absolute paths", () => {
        const matcher = makePathMatcher("/proj/src/config")("/home")("/proj")
...
describe("wildcards", () => {
    ...
    describe("* matches only within path segment", () => {
        test("* for part of segment", () => {
            const matcher = makePathMatcher("src/test*.ts")("/home")("/proj")
        ...
        test("* also matches empty part of name", () => {
            let matcher = makePathMatcher("*.ts")("/home")("/proj")
        ...
        test("/*/ requires exactly one segment", () => {
            const middle = makePathMatcher("src/*/test.ts")("/home")("/proj")
            ...
            const trailing = makePathMatcher("src/*")("/home")("/proj")
    ...
    describe("** matches through path separators", () => {
        ...
        test("leading **/ does nothing", () => {
            const matcher = makePathMatcher("**/test.ts")("/home")("/proj")
            expect(matcher("src/a/b/c/test.ts", undefined)).toBe(true)
            expect(matcher("src/test.ts", undefined)).toBe(true)
        ...
        test.each(
            ...
            const matcher = makePathMatcher("src" + pattern)("/home")("/proj")
            expect(matcher("src", undefined)).toBe(true)
            expect(matcher("src/", undefined)).toBe(true)
            expect(matcher("src/a/b/c/test.ts", undefined)).toBe(true)
            expect(matcher("src/components/test.ts", undefined)).toBe(true)
    ...
    test("mix of multiple wildcards", () => {
        const matcher = makePathMatcher("src/**/a/*/b/**/c/*.ts")("/home")("/proj")
...
describe("exceptions", () => {
    ...
    test("multiple exceptions", () => {
        const matcher = makePathMatcher("*.ts:!test.ts:!*.spec.ts")("/home")("/proj")
        expect(matcher("file.ts", undefined)).toBe(true)
...
describe("directory check", () => {
    ...
    test("partial x* -> matches both files and directories", () => {
        const matcher = makePathMatcher("src/file*")("/home")("/proj")
        expect(matcher("src/file", false)).toBe(true)
    ...
    test("with exception for parent of unknown type -> doesn't match parent", () => {
        const matcher = makePathMatcher("*:!unknown/**")("/home")("/proj")
...
describe("cwd", () => {
    ...
    test("only non-leading . or .. -> normalized, matches anywhere outside cwd", () => {
        const matcher = makePathMatcher("src/./config/../file")("/home")
    ...
    test("excessive .. -> collapses prefix, matches anywhere", () => {
        const matcher = makePathMatcher("src/../../file")("/home")
    ...
    test("./** -> matches anything within cwd", () => {
        const matcher = makePathMatcher("./**")("/home")
...
describe("home", () => {
    ...
    test("non-leading ~ -> just a segment name", () => {
        const matcher = makePathMatcher("src/~/nested/~some/file")("/home")("/proj")
    ...
    test("leading ~/.. -> home-relative, matches only some home-relative paths", () => {
        const matcher = makePathMatcher("~/../morty/config")("/users/rick")("/proj")
    ...
    test("home is root", () => {
        const matcher = makePathMatcher("~/path")("/")("/proj")
